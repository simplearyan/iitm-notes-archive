...
Consider a system of linear equations $\\begin{aligned} 2x\_1 +x\_2 = 1\\\\ -x\_1 +x\_3 + x\_4 = -1\\\\ x\_1 +x\_2 -x\_3 +x\_4 = 2\\\\ -x\_1 +x\_3 +x\_4 = 1. \\end{aligned}$ If the following matrix represents the augmented matrix of the system, then answer the questions 2,3 and 4.  
...
      $\\begin{aligned} \\text{System I:} & & x - y = 3 \\\\ & & -y + 2z = 1 \\\\ & & x + y + z = 0 \\\\ & & \\\\ \\text{System II:} & & x-y=3 \\\\ & & 2y +z=1 \\\\ & & 6y+3z=0 \\\\ & & \\\\ \\text{System III:} & & x-y=3 \\\\ & & 2y +z=1 \\\\ & & 6y+3z=3 \\\\ \\end{aligned}$  
...
Suppose $P$ is a $3\\times 3$ real matrix as follows: $\\begin{bmatrix} 1 & 0 & 1 \\\\ 0 & 1 & 1 \\\\ 0 & 0 & 1 \\end{bmatrix}$  
The vector $X\_n$ is defined by the recurrence relation $PX\_{n-1}=X\_n$. If $X\_2= \\begin{bmatrix} 7 \\\\ 8\\\\ 3 \\end{bmatrix}$, what is the sum of all the elements of $X\_0$?
...
        $\\begin{aligned} -x\_1+ x\_2 + 2x\_3 = 1\\\\ 2x\_1 + x\_2 -2x\_3 = -1\\\\ 3x\_2 + cx\_3 = d \\end{aligned}$  

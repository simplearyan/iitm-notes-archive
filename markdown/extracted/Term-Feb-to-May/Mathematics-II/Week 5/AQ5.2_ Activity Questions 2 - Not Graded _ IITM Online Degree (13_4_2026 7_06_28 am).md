---
title: "AQ5.2: Activity Questions 2 - Not Graded :: IITM Online Degree"
---

# AQ5.2: Activity Questions 2 - Not Graded :: IITM Online Degree
...
Let nullity of the matrix $A\_{3 \\times5}$ be 2. Find the rank of the matrix $A\_{3 \\times5}$.
...
$rank(A)+nullity (A)=max\\lbrace m, n \\rbrace$

$rank(A)+nullity (A)=min \\lbrace m, n \\rbrace$
...
If nullity of a $3\\times 3$ matrix is $c$ for some natural number $c$, $0\\leq c \\leq 3$, then the nullity of $-A$ will also be $c$.
...
If $A$ has $2$ columns which are non-zero and not multiples of each other, while the remaining columns are linear combinations of these $2$ columns, then $nullity(A) = 2$.

If $A$ has $2$ columns which are non-zero and not multiples of each other, while the remaining columns are linear combinations of these $2$ columns, then $nullity(A) = 1$.
...
$\\lbrace (-t,t, t) \\mid t\\in \\mathbb{R} \\rbrace$

$\\lbrace (t\_1,t\_2, \\frac{t\_2-t\_1}{2}) \\mid t\_1, t\_2\\in \\mathbb{R} \\rbrace$

$\\lbrace (t,- t, t) \\mid t\\in \\mathbb{R} \\rbrace$

$\\lbrace (t\_1,t\_2, \\frac{t\_1+t\_2}{2}) \\mid t\_1, t\_2\\in \\mathbb{R} \\rbrace$
...
$rank(A)=3, nullity(A)=2$

$rank(A)=2, nullity(A)=1$

$rank(A)=1, nullity(A)=2$

$rank(A)=2, nullity(A)=0$
...
$S\_1 = \\{(1,2,3), (4, 5, 6), (8, 9, 10)\\}$  
$S\_2 = \\{(1,2,1), (2, 4, 2), (1, 2, 5)\\}$  
$S\_3 = \\{(1,2,3), (4, 5, 6), (7, 8, 10)\\}$  
$S\_4 = \\{(1,2), (4, 5) \\}$  
$S\_5 = \\{(1,2), (4, 5), (3, 8) \\}$  
 Choose the set of correct options

$S\_1$ is a basis of $\\mathbb{R}^3$.

$S\_2$ is a basis of $\\mathbb{R}^3$.

$S\_3$ is a basis of $\\mathbb{R}^3$.

$S\_4$ is a basis of $\\mathbb{R}^2$.

$S\_5$ is a basis of $\\mathbb{R}^2$.
